...
<!-- 分页 -->
          ...
          var lines=document.getElementById("line").value;
           var pageSize= document.getElementById("pageSize").value;
            ...
            $("#pager").pager({ pagenumber: pageclickednumber, pagecount:Math.ceil(lines/pageSize), buttonClickCallback: PageClick });
             window.ifaborr.location="${ctx}/StaffController/selectUserByLimit.do?pageclickednumber="+pageclickednumber;
        }    
 ...
 <div class="form-inline definewidth m20">
		...
		<a href="${ctx}/StaffController/insertUser.do"><button type="button"
			...
			<div class="widget red">
				<div class="widget-title">
				 ...
				 <iframe style="width:99.5%;height:430px;" id="iframe"
									...
									src="${ctx}/StaffController/selectStaffMessageTable.do"
									name="ifaborr"> </iframe> 					
			</div>
			<!-- END EXAMPLE TABLE widget-->
	<div style="margin-top: -40px;" id="pager">
