						...
						<tbody>
							<c:forEach items="${yw_RightInformations}" var="item">
								<tr class="odd gradeX">						
									...
									<td>${item.typeofrightname}</td>							
										<td class="hidden-phone">
										<a onclick="window.location.href='${ctx}/CollectFees/selectCollectFees.do?parcelunitid=${item.parcelunitid}'" class="table-actions"><i
											class="icon-pencil">收费</i>
									    </a>
									</td>
