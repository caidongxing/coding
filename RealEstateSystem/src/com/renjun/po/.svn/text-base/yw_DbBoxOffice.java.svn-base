...
public class yw_DbBoxOffice {
    private Integer dbboxofficeid;
    ...
    private String send;
    public Integer getDbboxofficeid() {
        return dbboxofficeid;
    }

    public void setDbboxofficeid(Integer dbboxofficeid) {
        this.dbboxofficeid = dbboxofficeid;
    }
