...
public class yw_SfBoxOffice {
    private Integer sfboxofficeid;
    ...
    private String send;
    public Integer getSfboxofficeid() {
        return sfboxofficeid;
    }

    public void setSfboxofficeid(Integer sfboxofficeid) {
        this.sfboxofficeid = sfboxofficeid;
    }
