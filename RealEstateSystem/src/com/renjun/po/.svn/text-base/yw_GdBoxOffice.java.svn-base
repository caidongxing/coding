...
public class yw_GdBoxOffice {
    private Integer gdboxofficeid;
    ...
    private String send;
    public Integer getGdboxofficeid() {
        return gdboxofficeid;
    }

    public void setGdboxofficeid(Integer gdboxofficeid) {
        this.gdboxofficeid = gdboxofficeid;
    }
