...
public class yw_ParcelUnit {
    ...
    //新增字段
    private int typeofrightid;
    private int processclassificationid;
    private String usename;
    private String rightsettingwayname;
    private String landgradeidname;
	...
	public int getTypeofrightid() {
		return typeofrightid;
	}

	public void setTypeofrightid(int typeofrightid) {
		this.typeofrightid = typeofrightid;
	}

	public int getProcessclassificationid() {
		return processclassificationid;
	}

	public void setProcessclassificationid(int processclassificationid) {
	...
	public String getRightsettingwayname() {
		return rightsettingwayname;
	}

	public void setRightsettingwayname(String rightsettingwayname) {
		this.rightsettingwayname = rightsettingwayname;
	}

	public String getLandgradeidname() {
		return landgradeidname;
	}

	public void setLandgradeidname(String landgradeidname) {
		this.landgradeidname = landgradeidname;
	}

	/**
     * This method was generated by MyBatis Generator.
     * This method returns the value of the database column yw_parcelunit.parcelUnitId
     *
     * @return the value of yw_parcelunit.parcelUnitId
     *
     * @mbggenerated Thu Nov 24 16:14:02 CST 2016
     */
